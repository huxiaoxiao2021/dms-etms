$(function() {
	var saveUrl = '/collect/collectGoodsArea/save';
	var deleteUrl = '/collect/collectGoodsArea/deleteByIds';
  var detailUrl = '/collect/collectGoodsArea/detail/';
  var queryUrl = '/collect/collectGoodsArea/listData';
