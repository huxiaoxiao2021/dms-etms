$(function() {
	var saveUrl = '/storage/storagePackageD/save';
	var deleteUrl = '/storage/storagePackageD/deleteByIds';
  var detailUrl = '/storage/storagePackageD/detail/';
  var queryUrl = '/storage/storagePackageD/listData';
