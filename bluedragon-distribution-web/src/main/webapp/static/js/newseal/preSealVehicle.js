$(function() {
	var saveUrl = '/newseal/preSealVehicle/save';
	var deleteUrl = '/newseal/preSealVehicle/deleteByIds';
  var detailUrl = '/newseal/preSealVehicle/detail/';
  var queryUrl = '/newseal/preSealVehicle/listData';
