$(function() {
	var saveUrl = '/newseal/sealVehicles/save';
	var deleteUrl = '/newseal/sealVehicles/deleteByIds';
  var detailUrl = '/newseal/sealVehicles/detail/';
  var queryUrl = '/newseal/sealVehicles/listData';
