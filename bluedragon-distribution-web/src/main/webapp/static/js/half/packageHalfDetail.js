$(function() {
	var saveUrl = '/half/packageHalfDetail/save';
	var deleteUrl = '/half/packageHalfDetail/deleteByIds';
  var detailUrl = '/half/packageHalfDetail/detail/';
  var queryUrl = '/half/packageHalfDetail/listData';
