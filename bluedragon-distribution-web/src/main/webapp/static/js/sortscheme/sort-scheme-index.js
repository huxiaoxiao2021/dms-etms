    ...
    CommonClient.postJson(url, params, function (data) {
        ...
        if (data.code == 200) {
            ...
            for (var i = 0; i < dataList.length; i++) {
                ...
                temp += "<td><input id='" + dataList[i].id + "' value='" + dataList[i].yn + "' textContent='" + dataList[i].autoSend + "' name='singleBtn' type='checkbox'/></td>";
