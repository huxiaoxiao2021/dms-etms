...
public class DeviceCageGatewayServiceTest {
    @Autowired
    DeviceCageGatewayService deviceCageGatewayService;

    @Test
    public void getSortMachineBySiteCodeTest() {

        JdCResponse<List<String>> sortMachineBySiteCode = deviceCageGatewayService.getSortMachineBySiteCode(910);
        System.out.println(JSON.toJSONString(sortMachineBySiteCode));
    }
//
//    @Test
