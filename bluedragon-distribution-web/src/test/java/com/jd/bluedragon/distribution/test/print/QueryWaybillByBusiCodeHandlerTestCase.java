...
import com.jd.bluedragon.distribution.print.waybill.handler.QueryWaybillByBusiCodeHandler;
...
public class QueryWaybillByBusiCodeHandlerTestCase {
	@InjectMocks
	QueryWaybillByBusiCodeHandler queryWaybillByBusiCodeHandler;
    @Mock
