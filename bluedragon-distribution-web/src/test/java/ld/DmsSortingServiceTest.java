...
public class DmsSortingServiceTest {
    ...
    public void testBindingBoxMaterialPackageRelation() {
        for(int i = 0;i<10;i++) {
            InvokeResult<Boolean> result = iDmsSortingService.bindingBoxMaterialPackageRelation(JsonHelper.toObject("{\"boxCode\":\"MS1001221206290000100513\",\"businessType\":10,\"createSiteCode\":910,\"createSiteName\":\"北京马驹桥分拣中心\",\"createUser\":\"tms3f\",\"createUserCode\":1382444018,\"featureType\":0,\"isCancel\":0,\"isLoss\":0,\"materialCode\":\"AY0101010000599\",\"needBindMaterialFlag\":1,\"operateTime\":\"2023-09-21 21:02:46\",\"packageCode\":\"JDVC00003095700-1-3-\",\"receiveSiteCode\":267460,\"receiveSiteName\":\"站点所属分拣\",\"waybillCode\":\"JDVC00003095700\"}", SortingRequestDto.class));
            System.out.println(JsonHelper.toJSONString(result));
        }
    }
    @Test
