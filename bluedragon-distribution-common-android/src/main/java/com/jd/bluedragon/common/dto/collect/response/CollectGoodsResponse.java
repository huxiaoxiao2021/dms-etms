package com.jd.bluedragon.common.dto.collect.response;

import java.io.Serializable;

public class CollectGoodsResponse implements Serializable{
    ...
    public String toString() {
        return getCollectGoodsAreaCode()==null ? "" : getCollectGoodsAreaCode();
    }
