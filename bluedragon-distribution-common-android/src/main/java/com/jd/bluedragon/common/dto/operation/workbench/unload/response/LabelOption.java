 ...
 * @Date 2022/4/9 17:46
 **/
public class LabelOption implements Serializable {
    ...
    public LabelOption(Integer code, String name) {
        this.init(code, name, null, null);
    }

    public LabelOption(Integer code, String name, Integer order) {
        this.init(code, name, order, null);
    }

    public LabelOption(Integer code, String name, Integer order, Boolean display) {
