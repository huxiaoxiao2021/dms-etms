...
@XmlRootElement(name = "updatePrintEMSWeigth")
public class UpdatePrintEMSWeigth {

    @XmlElementRef(name = "xmlStr", namespace = "http://printService.webservice.bigaccount.hollycrm.com", type = JAXBElement.class)
