...
public class JySendGoodsAggsBakConsumer extends MessageBaseConsumer {
    ...
    public void consume(Message message) throws Exception {
        ...
        String lockKey =String.format(CacheKeyConstants.JY_SEND_AGG_BAK_LOCK_KEY,entity.getBizId());
        try{
            //加锁处理
            ...
            if(lock){
                ...
                Boolean result = jySendAggsService.insertOrUpdateJySendGoodsAggsBak(entity);
                if(result){
                    // 消费成功，记录数据版本号
                ...
                logger.warn("JySendGoodsAggsBakConsumer 获取锁失败");
