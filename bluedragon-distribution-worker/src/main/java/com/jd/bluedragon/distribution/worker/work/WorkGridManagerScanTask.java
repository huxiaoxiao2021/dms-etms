...
/**
 * 任务线上化-扫描任务
 * 定时扫描task_work_grid_manager_scan数据记录，执行任务检查逻辑，生成相应的task_work_grid_manager_site_scan数据
 * @author wuyoude
 *
 */
public class WorkGridManagerScanTask extends DBSingleScheduler {
    ...
    public WorkGridManagerScanTask(){
    	super();
    }
    @Override
    
    public boolean executeSingleTask(Task task, String ownSign) throws Exception {
        return jyWorkGridManagerBusinessService.executeWorkGridManagerScanTask(task);
    }
