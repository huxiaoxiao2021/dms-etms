...
public enum JyFuncCodeEnum {
    ...
    INTERNATIONAL_SPECIAL_POSITION("INTERNATIONAL_SPECIAL_POSITION","国际化特殊岗位"),
    AVIATION_RAILWAY_SEND_SEAL_POSITION("AVIATION_RAILWAY_SEND_SEAL_POSITION", "空铁发货封车岗"),
    CONTRABAND_POSITION("CONTRABAND_POSITION","安检岗"),
    COLLECT_PACKAGE_POSITION("COLLECT_PACKAGE_POSITION","小件集包岗"),
    AVIATION_RAILWAY_PICKING_GOOD_POSITION("AVIATION_RAILWAY_PICKING_GOOD_POSITION", "空铁提货岗"),
    COLDCHAIN_TEMPORARY_IN_POSITION("COLDCHAIN_TEMPORARY_IN_POSITION","冷链暂存入库岗"),
    COLLECT_LOADING_POSITION("COLLECT_LOADING_POSITION","集装岗")
