package com.jd.bluedragon.distribution.bagException.vo;
 ...
 *
 * @author fanggang7
 * @time 2020-09-23 22:07:31 周三
 */
public class CollectionBagExceptionReportVo implements Serializable {

    private static final long serialVersionUID = 440761017387501165L;
     ...
     * 举报时间
     */
    private String reportTimeFormative;
    ...
    public String getReportTimeFormative() {
        return reportTimeFormative;
    }

    public void setReportTimeFormative(String reportTimeFormative) {
        this.reportTimeFormative = reportTimeFormative;
    }
