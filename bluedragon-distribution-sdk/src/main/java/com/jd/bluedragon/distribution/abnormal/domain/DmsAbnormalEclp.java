...
/**
 * @author wuyoude
 * @ClassName: DmsAbnormalEclp
 * @Description: ECLP外呼申请表-实体类
 * @date 2018年03月14日 16:31:20
 */
public class DmsAbnormalEclp extends DbEntity {

    private static final long serialVersionUID = 1L;

    public static final Integer DMSABNORMALECLP_RECEIPT_YES = 1; //已回复
    public static final Integer DMSABNORMALECLP_RECEIPT_NO = 0;//未回复
