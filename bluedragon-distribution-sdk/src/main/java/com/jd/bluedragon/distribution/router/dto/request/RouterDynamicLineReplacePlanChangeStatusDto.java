 ...
 */
public class RouterDynamicLineReplacePlanChangeStatusDto extends Page implements Serializable {
     ...
     * 启用状态 前者
     */
    private Integer enableStatusPrev;
    /**
    ...
    public RouterDynamicLineReplacePlanChangeStatusDto(){
    }
    public RouterDynamicLineReplacePlanChangeStatusDto(Long id){
        this.id = id;
    }
    ...
    public Integer getEnableStatusPrev() {
        return enableStatusPrev;
    }

    public void setEnableStatusPrev(Integer enableStatusPrev) {
        this.enableStatusPrev = enableStatusPrev;
    }
