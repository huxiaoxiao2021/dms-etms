...
CREATE TABLE `cen_confirm` (
  ...
  `OPERATE_TYPE` int(10) DEFAULT NULL,
...
CREATE TABLE `inspection` (
  ...
  `WAYBILL_TYPE` int(10) DEFAULT NULL,
  `OPERATE_TYPE` int(10) DEFAULT NULL,
...
CREATE TABLE `pop_queue` (
  ...
  `CREATE_USER` varchar(32) DEFAULT NULL,
  `OPERATE_TIME` datetime DEFAULT NULL,
  `QUEUE_STATUS` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `gantry_device_info` (
  ...
  `ORG_CODE` double DEFAULT NULL,
  `ORG_NAME` varchar(32) DEFAULT NULL,
  `SITE_CODE` double DEFAULT NULL,
...
CREATE TABLE `gantry_device_config` (
  `ID`  bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `MACHINE_ID` double DEFAULT NULL,
  `OPERATE_USER_ID` double DEFAULT NULL,
  ...
  `START_TIME` datetime DEFAULT NULL,
  `END_TIME`  datetime DEFAULT NULL,
  `LOCK_STATUS`  double DEFAULT NULL,
