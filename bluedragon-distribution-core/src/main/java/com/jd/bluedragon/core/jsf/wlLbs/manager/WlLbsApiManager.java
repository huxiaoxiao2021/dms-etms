 ...
 */
public interface WlLbsApiManager {
     ...
     */
    com.jd.lbs.geocode.api.base.BaseResponse<GisPointDto> geo(String appId, String address);
     ...
     */
    com.jd.lbs.geocode.api.base.BaseResponse<GisPointDto> regeo(String appId, BigDecimal latitude, BigDecimal longitude);
     ...
     */
    com.jd.lbs.jdlbsapi.dto.BaseResponse<LocationResultDto> getLocationByIp(String appKey, LocationRequestDto locationRequestDto);
     ...
     */
    com.jd.lbs.jdlbsapi.dto.BaseResponse<BigDecimal> getLength(String appKey, PointDto startPoint, PointDto endPoint);
