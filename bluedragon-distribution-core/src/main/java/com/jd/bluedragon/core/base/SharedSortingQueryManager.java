...
public interface SharedSortingQueryManager {
     ...
     * @return
     */
    ApiResult<PageInfo<Sorting>> queryPackList(Integer operateSiteId,String waybillCode,String objectCode,SortingDirection sortingDirection,PageInfo pager);
     ...
     * @return
     */
    ApiResult<PageInfo<Sorting>> queryByPage(Integer operateSiteId,String packageCode,PageInfo pager);
}
