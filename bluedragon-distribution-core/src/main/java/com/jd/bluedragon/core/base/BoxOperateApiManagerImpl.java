...
public class BoxOperateApiManagerImpl implements BoxOperateApiManager {
     ...
     */
    @Override
    @JProfiler(jAppName = Constants.UMP_APP_NAME_DMSWORKER,jKey = "DMS.BASE.WorkTaskServiceManagerImpl.findBoxDetailInfoList", mState = {JProEnum.TP, JProEnum.FunctionError})
    public BoxDetailResultDto findBoxDetailInfoList(String boxCode) {
        return boxOperateApi.findBoxDetailInfoList(initCommonParam(),boxCode);
    }
