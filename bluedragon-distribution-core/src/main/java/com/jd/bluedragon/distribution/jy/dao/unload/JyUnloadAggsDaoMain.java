 ...
 */
public class JyUnloadAggsDaoMain extends BaseDao<JyUnloadAggsEntity> implements JyUnloadAggsDaoStrategy {

    private static final String DB_TABLE_NAME = "jy_unload_aggs";

    final static String NAMESPACE = JyUnloadAggsDaoMain.class.getName();
    ...
    public List<JyUnloadAggsEntity> getUnloadAggsMainData(JyUnloadAggsEntity entity) {
        return this.getSqlSession().selectList(NAMESPACE + ".getUnloadAggsMainData", entity);
    }
}
