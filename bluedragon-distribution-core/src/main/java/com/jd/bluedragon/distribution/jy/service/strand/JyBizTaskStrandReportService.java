...
public interface JyBizTaskStrandReportService {
     ...
     * @return
     */
    InvokeResult<Void> artificialCreateStrandReportTask(JyStrandReportTaskCreateReq request);
     ...
     * @return
     */
    InvokeResult<Void> systemCreateStrandReportTask(JyStrandReportTaskCreateReq request);
     ...
     * @return
     */
    InvokeResult<Void> regularDealStrandReport();
