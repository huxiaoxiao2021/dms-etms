...
public enum BizOperateTypeConstants {
    ...
    DELIVERY_REVERSE_GETSENDDETIAL(100, 1014),//发货，亚一逆向获得发货明细
    DELIVERY_REVERSE_MOBILE_DELIVERY(100, 1015),//发货，移动仓内配单发货
    DELIVERY_REVERSE_WMS_GETSENDDETIAL(100, 1016),//发货，WMS逆向获得发货明细
    DELIVERY_REVERSE_SPECIAL_DELIVERY(100, 1017),//发货，逆向发货迷你仓
    DELIVERY_REVERSE_ECLP_DELIVERY(100, 1018),//发货，逆向发货ECLP
    DELIVERY_REVERSE_CLPS_DELIVERY(100, 1019),//发货，逆向发货CLPS
    DELIVERY_REVERSE_ECLP_SPWMS_DELIVERY(100, 1020),//发货，逆向发货ECLP_SPWMS
    DELIVERY_REVERSE_SPWMS_DELIVERY(100, 1021),//发货，逆向发货SPWMS
    DELIVERY_COLDCHAIN_SMS(100, 1022),//发货,冷链卡班暂存计费发短信
