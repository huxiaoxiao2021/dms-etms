...
public class CancelWaybill {
    ...
    public static final Integer FEATURE_TYPE_KY_CHANGE_ADDRESS_CHANGE_WAYBILL = 11;//快运改址换单拦截 对应原9的部分场景
    public static final Integer FEATURE_TYPE_KD_CHANGE_ADDRESS_CHANGE_WAYBILL = 12;//快递改址换单拦截 对应原6的部分场景
    ...
    public static ImmutableList<Integer> FEATURE_TYPES_NEED_PACKAGE_DEAL =
            ImmutableList.of(FEATURE_TYPE_ORDER_MODIFY, FEATURE_TYPE_C_TRANSPORT_B, FEATURE_TYPE_B_TRANSPORT_C, FEATURE_TYPE_KY_ADDRESS_MODIFY_INTERCEPT,
                    FEATURE_TYPE_KD_CHANGE_ADDRESS_CHANGE_WAYBILL, FEATURE_TYPE_KY_CHANGE_ADDRESS_CHANGE_WAYBILL);
    /**待处理的包裹最多查询数量*/
