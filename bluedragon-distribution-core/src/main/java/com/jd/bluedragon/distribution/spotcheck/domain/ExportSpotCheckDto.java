 ...
 *
 * @author hujiping
 * @date 2021/12/13 8:02 下午
 */
public class ExportSpotCheckDto {
    ...
    public String getIsTrustMerchant() {
        return isTrustMerchant;
    }

    public void setIsTrustMerchant(String isTrustMerchant) {
    ...
    public void setContrastWeight(String contrastWeight) {
        this.contrastWeight = contrastWeight;
    }

    public String getContrastVolume() {
        return contrastVolume;
    }

    public void setContrastVolume(String contrastVolume) {
    ...
    public void setIsGatherTogether(String isGatherTogether) {
    ...
    public String getIsIssueDownstream() {
        return isIssueDownstream;
    }

    public void setIsIssueDownstream(String isIssueDownstream) {
