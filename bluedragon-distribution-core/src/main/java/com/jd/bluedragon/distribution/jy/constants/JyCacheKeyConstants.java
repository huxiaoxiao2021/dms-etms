...
public class JyCacheKeyConstants {
    ...
    public static final String JY_EXCEPTION_TASK_CACHE_PRE_KEY = "DMS:JYAPP:EXP:TASK_CACHE01:%s";
    public static final String JY_EXCEPTION_TASK_RECEIVING_POSITION_COUNT_PRE_KEY = "DMS:JYAPP:EXP:RECEIVING_POSITION_COUNT_PRE02:";
    public static final String JY_EXCEPTION_TASK_RECEIVING_SITE_COUNT_PRE_KEY = "DMS:JYAPP:EXP:RECEIVING_SITE_COUNT_PRE03:";
