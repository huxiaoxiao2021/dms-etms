 ...
 */
public class JySendAggsDaoMain extends BaseDao<JySendAggsEntity> implements JySendAggsDaoStrategy {

    private final static String NAMESPACE = JySendAggsDaoMain.class.getName();
