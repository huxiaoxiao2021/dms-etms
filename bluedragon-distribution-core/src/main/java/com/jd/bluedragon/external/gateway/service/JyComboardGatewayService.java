...
public interface JyComboardGatewayService {
     ...
     * @return
     */
    JdCResponse<HaveScanStatisticsResp> queryHaveScanStatisticsUnderBoard(HaveScanStatisticsReq request);
    /**
     * 查询箱子内部的包裹详情
     */
     ...
     * 查询流向待扫统计数据-支撑下钻5
     */
    JdCResponse<WaitScanStatisticsResp> queryWaitScanStatisticsUnderSendFlow(WaitScanStatisticsReq request);
     ...
     */
    JdCResponse<BoardExcepStatisticsResp> queryExcepScanStatisticsUnderBoard(BoardExcepStatisticsReq request);
     ...
     * @return
     */
    JdCResponse<SendFlowExcepStatisticsResp> queryExcepScanStatisticsUnderCTTGroup(SendFlowExcepStatisticsReq request);
