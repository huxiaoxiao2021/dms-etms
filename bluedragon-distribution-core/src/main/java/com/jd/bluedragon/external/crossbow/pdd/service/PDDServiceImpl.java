...
public class PDDServiceImpl implements PDDService {
    ...
    public PDDResponse<PDDWaybillDetailDto> queryPDDWaybillInfoByWaybillCodeWithCacheAndSource(String waybillCode, String source, Boolean cacheSwitch, Boolean waybillSwitch) {
        ...
        CallerInfo callerInfo = Profiler.registerInfo("DMS.WEB.PDDService.queryPDDWaybillInfoByWaybillCodeWithCacheAndSource_all_" + source, false,false);
        ...
        CallerInfo callerInfo1 = Profiler.registerInfo("DMS.WEB.PDDService.queryPDDWaybillInfoByWaybillCodeWithCacheAndSource_to_pdd_all_" + source,false,false);
        CallerInfo callerInfo2 = null;
        // 3. 调用pdd的外部接口，获取返回值信息
        if (this.queryPDDWaybillInPDD(waybillCode, response)) {
            callerInfo2 = Profiler.registerInfo("DMS.WEB.PDDService.queryPDDWaybillInfoByWaybillCodeWithCacheAndSource_to_pdd_success_" + source,false,false);
        }
