...
public class TestCase {
	...
	public void test() {
		...
		// List<Map<String, Object>> lossOrderDetails = (List<Map<String,
		// Object>>) lossOrderMap
		// .get("productList");
		// if (lossOrderMap != null) {
		//
		// }
		// System.out.println("1:" + lossOrderMap.get("id"));
		// System.out.println("1:" + lossOrderMap.get("orderId"));
		// System.out.println("1:" + lossOrderMap.get("userErp"));
		// System.out.println("1:" + lossOrderMap.get("userName"));
		// System.out.println("1:" + lossOrderMap.get("lossTime"));
		// System.out.println("1:" + lossOrderDetails.get(0).get("lossType"));
		// System.out.println("1:" +
		// lossOrderDetails.get(0).get("productQuantity"));
		// }
		
		// ReverseSendWms send = new ReverseSendWms();
		// System.out.println(send.getType().equals(18));
		// System.out.println(XmlHelper.toXml(send, ReverseSendWms.class));
