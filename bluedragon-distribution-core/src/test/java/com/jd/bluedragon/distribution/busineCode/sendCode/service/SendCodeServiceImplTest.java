...
public class SendCodeServiceImplTest {
    ...
    public void createSendCode() {
        Map<BusinessCodeAttributeKey.SendCodeAttributeKeyEnum, String> param = new HashMap<>();
    ...
    public void isFreshSendCode() {
        Map<BusinessCodeAttributeKey.SendCodeAttributeKeyEnum, String> param1 = new HashMap<>();
        ...
        Map<BusinessCodeAttributeKey.SendCodeAttributeKeyEnum, String> param2 = new HashMap<>();
        ...
        Map<BusinessCodeAttributeKey.SendCodeAttributeKeyEnum, String> param3 = new HashMap<>();
